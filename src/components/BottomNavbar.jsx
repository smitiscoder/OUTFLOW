...
const BottomNavbar = () => {
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-[#03071E]/90 backdrop-blur-lg border-t border-white/10 py-2 z-50">
      <div className="relative flex items-center justify-around max-w-md mx-auto">

        {/* Curved background behind + button */}
        <div className="absolute -top-6 left-1/2 -translate-x-1/2 w-16 h-16 bg-[#03071E] rounded-full z-0 shadow-lg" />

        {/* Home */}
        <Button variant="ghost" size="icon" className="text-[#D9D9D9] hover:bg-[#03071E]/50 z-10">
        ...
        <Button
          variant="ghost"
          size="icon"
          className="text-white relative -top-8 z-20 p-4 bg-gradient-to-br from-green-400 to-green-600 hover:from-green-500 hover:to-green-700 shadow-lg hover:shadow-xl transition-all">
          <Link to="/ExpenseCategory" className="flex items-center justify-center w-full h-full">
            <span className="text-3xl font-bold text-[#03071E]">+</span>
          </Link>
        </Button>
