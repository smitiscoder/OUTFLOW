  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white px-4 pt-6 pb-28 max-w-md mx-auto">
      <div className="relative mb-4">
        <input
          type="text"
          className="w-full rounded-full bg-white/10 border border-white/10 px-4 py-3 pr-10 text-sm text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500"
