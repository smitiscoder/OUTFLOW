...
const MainLayout = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col w-full overflow-x-hidden bg-[#0D0D0D]">
      ...
      <div className="flex-1 w-full overflow-x-hidden px-4 sm:px-6 md:px-8 lg:px-10 pb-20 sm:pb-24 md:pb-28">
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 bg-[#0D0D0D]/95 backdrop-blur-sm border-t border-white/5">
        <BottomNavbar />
      </div>
    </div>
  );
