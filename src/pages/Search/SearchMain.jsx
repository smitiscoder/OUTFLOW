...
export default function SearchMain() {
  ...
  return (
    <div className="min-h-screen bg-[#0D0D0D] text-[#DFDFDF]">
      <div className="w-full max-w-full sm:max-w-[640px] md:max-w-[768px] lg:max-w-[1024px] mx-auto px-4 sm:px-6 md:px-8 pb-20 sm:pb-24 md:pb-28">
        {/* Header with responsive text and spacing */}
        <header className="py-4 sm:py-6 flex items-center justify-between mt-4 sm:mt-6">
          <h1 className="text-xl sm:text-2xl md:text-3xl font-bold">Search Expenses</h1>
        </header>
