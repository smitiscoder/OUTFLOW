...
import { Check, Delete } from "lucide-react"; // Removed Calendar
// import { format } from "date-fns"; // Commented out for date handling
...
const Keyboard = ({ onSubmit }) => {
  ...
  const handleSubmit = () => {
    ...
    onSubmit({
      amount,
      note,
      // date: dateString, // Commented for now
    });
      ...
      */}
      ...
      <div className="grid grid-cols-3 gap-2 mb-2">
        ...
        <div className="col-span-3 grid grid-cols-3 gap-2">
          {/* <button onClick={toggleCalendar} className="py-3 rounded-md bg-[#1A1A1A] hover:bg-[#333333] active:bg-[#444444] transition-colors flex justify-center items-center">
