...
const Sharepage = () => {
  ...
  return (
    <section className="min-h-screen flex flex-col items-center py-8 sm:py-12 md:py-24 relative overflow-hidden bg-[#0D0D0D] text-white">
      {/* Back Button and Share Page Text */}
      <div className="absolute top-4 sm:top-6 left-4 sm:left-6 flex items-center space-x-2">
        ...
        <h1 className="text-lg sm:text-2xl font-bold">Share Outflow</h1>
      </div>
